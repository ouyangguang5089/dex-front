  ...
  return (
    <div {...props} >
      <svg width="30px" height="30px" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="paint1_linear_1" x1="52" y1="7" x2="-7.5" y2="75" gradientUnits="userSpaceOnUse">
            <stop stopColor="#CEF249" />
            <stop offset="1" stopColor="#CEF249" stopOpacity="0" />
          </linearGradient>
          <linearGradient id="paint1_linear_2" x1="48" y1="93" x2="93" y2="45" gradientUnits="userSpaceOnUse">
            <stop stopColor="#CEF249" />
            <stop offset="1" stopColor="#CEF249" stopOpacity="0" />
          </linearGradient>
        </defs>
        <g id="logo">
          <g id="Group 427319185">
            <path id="Vector" d="M42.5 50L52.5 7C26.25 7.24571 5 25.92 5 48.7714C5 49.14 5 49.6314 5 50H42.5Z" fill="url(#paint1_linear_1)" />
            <path id="Vector_2" d="M57.5 50L47.5 93C73.75 92.7543 95 74.08 95 51.2286C95 50.86 95 50.3686 95 50H57.5Z" fill="url(#paint1_linear_2)" />
